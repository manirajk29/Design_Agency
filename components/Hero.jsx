...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col items-center justify-center pt-28 pb-16 overflow-hidden bg-[#050508]"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 w-full flex flex-col items-center justify-center relative z-10 select-none">
        ...
        >
          ...
          <div className="absolute top-[8%] left-[-4%] w-[11.5vw] h-[11.5vw] max-w-[150px] max-h-[150px] min-w-[55px] min-h-[55px] rounded-full overflow-hidden border-[0.3vw] md:border-[5px] border-[#050508] shadow-2xl z-20 select-none">
            <Image
          ...
          <div className="absolute top-[8%] left-[64%] w-[11.5vw] h-[11.5vw] max-w-[150px] max-h-[150px] min-w-[55px] min-h-[55px] rounded-full overflow-hidden border-[0.3vw] md:border-[5px] border-[#050508] shadow-2xl z-20 select-none">
            <Image
          ...
          {/* Avatar 3: Overlaps Bottom Left area of T/R */}
          <div className="absolute bottom-[8%] left-[10%] w-[11.5vw] h-[11.5vw] max-w-[150px] max-h-[150px] min-w-[55px] min-h-[55px] rounded-full overflow-hidden border-[0.3vw] md:border-[5px] border-[#050508] shadow-2xl z-20 select-none">
            <Image
          ...
          <div className="absolute bottom-[28%] left-[78%] w-[11.5vw] h-[11.5vw] max-w-[150px] max-h-[150px] min-w-[55px] min-h-[55px] rounded-full overflow-hidden border-[0.3vw] md:border-[5px] border-[#050508] shadow-2xl z-20 select-none">
            <Image
          ...
          <div className="absolute bottom-[-10%] right-[-5%] w-[13.5vw] h-[13.5vw] max-w-[170px] max-h-[170px] min-w-[80px] min-h-[80px] select-none pointer-events-auto z-30">
        ...
        <motion.div
          ...
          className="w-full flex flex-col items-center justify-center mt-12 sm:mt-16 text-center"
        >
